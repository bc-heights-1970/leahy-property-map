var config = {
    style: 'mapbox://styles/geoelasmar/cmni2giup00ax01qog6iwhnhg',
    accessToken: 'pk.eyJ1IjoiZ2VvZWxhc21hciIsImEiOiJjbW5pMjNwaWgwOTE5MnVxNGhxbXdiYWI2In0.FxAHme7Wu7XLuMnfjAVXwA',
    showMarkers: false,
    markerColor: '#3FB1CE',
    inset: true,
    insetOptions: {
    ...
    chapters: [
        {
            ...
            alignment: 'left',
            hidden: false,
            title: "180-Acre Beginnings",
            description:` <img src="./assets/leahy-beginnings.png" style="width:100%; margin-bottom: 4px;">
            ...
            <p>University President Rev. William P. Leahy, S.J., first encountered Boston College&rsquo;s campus as a Ph.D. student in 1982, when he visited for a few weeks to work on his dissertation on 20th-century Jesuit education.</p>
                        ...
                        <p>&ldquo;I&apos;ve observed that BC&rsquo;s growth reflects intentional, mission‑driven development, using physical space as a strategic tool to advance the mission,&rdquo; Hermano wrote in a statement to <em>The Heights.</em></p>

                        <p>Here&rsquo;s a chronological look back at how BC expanded during Leahy&rsquo;s tenure.</p>

                        <p><em>Click on the properties highlighted in red to view their acquisition dates and purchase prices. Properties highlighted in yellow were owned by BC before Leahy became president.</em></p>`,


            location: {
                center: [-71.175, 42.336],
                zoom: 14.84,
                pitch: 0,
                bearing: 0
            },
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'BC Goes to Ireland',

            description: ` <img src="./assets/bc-ireland.jpg" style="width:100%; margin-bottom: 4px;">
...
Ireland, and the Irish Institute works with programs to utilize
American resources in assisting Ireland. 
</p>

<p>&quot;The opening of the Boston College
Center in Ireland is a natural extension of our commitment to working
with the Irish people in both Ireland and Northern Ireland,&quot;
Leahy said.</p>

<p>The property became a center for
students, staff, and alumni in Ireland, with many events and
resources. BC Ireland hosts students studying abroad for classes
during the school year and the summer, as well as a summer internship
program.</p>
...
Irish U.S. Alumni Association.</p>`,
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'Crossing Commonwealth Avenue',

            description: `<img src="./assets/brighton-campus.png" style="width:100%; margin-bottom: 4px;">
                <p style="font-size: 13px; color: #888; margin: 0 0 12px 0; font-style: italic;">(Sam Zhai / Heights Archives)</p>
...
archdiocese's central administration since the late 1920s—had been
built over decades into an expansive compound of seminary buildings,
...
<p>&quot;I think our alumni will be
supportive because they realize the opportunity that this sale
presents to Boston College,&quot; Dunn said. &quot;And it will help
the Archdiocese of Boston in its time of need.&quot;</p>

<p>BC purchased an additional 3.25 acres
of adjoining land two years later for $8 million, and the remaining
18 acres for $65 million in 2007. By the time the final deed was
signed, BC had acquired 66 acres from the Archdiocese of Boston,
along with a number of buildings.</p>

<img src="./assets/mcmullen-museum.jpg" style="width:100%; margin-bottom: 4px;">
<p style="font-size: 13px; color: #888; margin: 0 0 12px 0; font-style: italic;">(Heights Archives)</p>
...
its fifth school within the University. 
</p>
...
Advancement, Human Resources, and University Communications.</p>`,
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: '79 Acres in Dover',

            description: `<p>Months after
the first Brighton purchase, Leahy turned his attention to another
religious property 20 miles southwest.</p>

<p>In 2004, BC acquired St. Stephen's
Priory—a 78.5-acre estate along the Charles River in Dover,
Mass.—for approximately $16.5 million.</p>

<p>The estate, built in 1902, was
originally a private family home, with gardens and paths created by
the designers of Central Park. 
</p>

<p>The Dominican Fathers purchased the
estate in 1951 and operated it as a religious retreat for over five
decades before deciding to close the priory in 2004.</p>

<p>BC acquired it to meet the rising
...
<p>The space is now used for retreats,
weddings, conferences, meetings, and other events.</p>

<p>The property bordering the Charles
River includes 78.5 acres of wooded land, 70,000 square feet of
buildings, and gardens.</p>`,

            location: {
                center: [-71.334,42.240],
                zoom: 14.36,
                pitch: 0,
                bearing: 0
            },
        ...
        {
            id: '300-hammond-pond-pkwy',
            alignment: 'left',
            hidden: false,
            title: 'A Newton Land Feud',
            description: `
...
its Chestnut Hill site since the mid-1950s, when it acquired the
...
<p>The deal closed in 2016 for $20
million. BC said it planned to use the mostly wooded site for
overflow parking and administrative offices. 
</p>
<p>The acquisition quickly drew scrutiny
from Newton conservation groups, who feared what BC intended to do
with the 17.4 acres of undeveloped forest at the back of the
...
grounds.</p>
<p>The Jesuit Community of Boston College
purchased the property in 1932 for $87,000. For decades, it served as
a summer retreat for BC's Jesuits and a conference site for faculty.</p>
<p>In 2017, BC purchased Bellarmine House
from the Jesuit Community and transferred it into the university's
institutional portfolio. It now operates under BC's Division of
Mission and Ministry, available to students, faculty, and staff for
retreats and events.</p>`,

            location: {
                center: [-70.791, 42.244],
                zoom: 15.54,
                pitch: 0,
                bearing: 0
            },
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'The Pine Manor Deal',

            description: `<img src="./assets/messina-college.jpg" style="width:100%; margin-bottom: 4px;">
                <p style="font-size: 13px; color: #888; margin: 0 0 12px 0; font-style: italic;">(Sarah Fleming / Heights Archives)</p>
...
center, six tennis courts, and a soccer field. 
</p>
...
`,
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'An Addition to Newton Campus',

            description: `<img src="./assets/mount-alvernia.png" style="width:100%; margin-bottom: 4px;">
                <p style="font-size: 13px; color: #888; margin: 0 0 12px 0; font-style: italic;">(Nicole Vagra / Heights Archives)</p>
...
<p>The 23-acre property, which consists of
...
<p>In December 2024, BC announced it would
...
Teacher Corps, a program housing teachers in the area.</p>`,
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: '430 Acres and Counting',

            description: `<img src="./assets/catholic-religious-archives.jpg" style="width:100%; margin-bottom: 4px;">
                <p style="font-size: 13px; color: #888; margin: 0 0 12px 0; font-style: italic;">(Photo Courtesy of University Communications)</p>
...
A campus minister by background, Butler has said little publicly
